...
table.num<-table.num+1
```
Table `r table.num`. Percent change in each region across pre-bridge construction (pre-2003), post-bridge construction (2003-2017), and all years. Percent change values are followed by 95% confidence intervals in parentheses.
```{r, echo=FALSE}
