...
###North Bay
The North Bay region DCCO populations show very significant variability in trend estimates across colonies, with some growing and some declining in the same years. This lead to large error estimates in the regional trend, and also highly variable mean regional trend estimates that fluctuated around the same value for the duration of the study in that region, from 1989 to 2017.
