...
# Methods
##Exponential and logrithmic growth models
...
##Generalized Additive Mixed Models (GAMMs) with decomposed long-term and short-term trends
...
######Page break
Table 3. Percent annual change in estimated nest counts by region according to poptrend models (GAMM with longg-term and short-term trends modeled discretely).
```{r, echo=FALSE}
...
```
Fig 4. Regional counts over time in the North Bay region with fitted exponential model.
...
```
Fig 8. Colony counts (top), GAM colony trends with SE (middle), and GAM regional trend (bottom) for Bridges region.
...
```
Fig 9. Colony counts (top), GAM colony trends with SE (middle), and GAM regional trend (bottom) for North Bay region.
...
```
Fig 10. Colony counts (top), GAM colony trends with SE (middle), and GAM regional trend (bottom) for Outer Coast region.
...
```
Fig 11. Colony counts (top), GAM colony trends with SE (middle), and GAM regional trend (bottom) for South Bay region.
...
```
Fig 12. Colony counts (top), GAM colony trends with SE (middle), and GAM regional trend (bottom) for South Farallon Islands region.
...
Fig 14. Trend estimate for all regions in the San Francisco Bay Area with the exception of the Bridges. DCCO nest counts appear as x's.
...
Fig 15. Trend estimate for all regions in the San Francisco Bay Area including the Bridges. DCCO nest counts appear as x's.
